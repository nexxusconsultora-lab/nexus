...
export async function onRequestPost(context) {
  ...
  // ANTHROPIC_API_KEY puede llegar como "Secrets Store binding" (objeto
  // con método .get(), el sistema nuevo de Cloudflare) o como variable de
  // entorno de texto simple (el sistema viejo). Soportamos ambas.
  let apiKey = "";
  if (env.ANTHROPIC_API_KEY && typeof env.ANTHROPIC_API_KEY.get === "function") {
